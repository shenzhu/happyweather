package com.shenzhu.android.happyweather.activity.service;
...
import com.shenzhu.android.happyweather.activity.receiver.AutoUpdateReceiver;
...
public class AutoUpdateService extends Service{
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
        ...
        int anHour = 8 * 60 * 60 * 1000; // miniseconds
